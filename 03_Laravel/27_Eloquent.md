...
To demonstrate, we'll create an example in the [PracticeController](https://github.com/susanBuck/dwa15-fall2017/blob/master/03_Laravel/99_Practice_Work.md#option-2-practice-controller) that demonstrates adding a new book using Eloquent's [`save`](https://laravel.com/docs/eloquent#inserts) method.
...
This can be abbreviated using the Model as a [facade](https://github.com/susanBuck/dwa15-fall2017/blob/master/03_Laravel/10_Facades.md), e.g.:
